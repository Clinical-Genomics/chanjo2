...
def delete_intervals_for_build(db: Session, interval_type: Union[SQLGene], build: Builds) -> None:
...
def count_intervals_for_build(db: Session, interval_type: Union[SQLGene], build: Builds) -> int:
