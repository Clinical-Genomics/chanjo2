...
- On Mane transcripts overwiew, do not duplicate lines when a gene has both `MANE Select` and `MANE Plus Clinical` transcript ()
...
- MIT license file (#54)
- Files with chr X and Y transcripts and exons, to be used for calculating stats on sex chromosomes (#504)
### Changed
