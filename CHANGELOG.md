...
- Dockerized chanjo2 uses pyd4 v0.3.9 provided the Docker base image
- pyd4 lib must be installed separately when installed locally - Docs updated accordingly
### Fixed
